...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  setChartSourceFile: (source) => ipcRenderer.send('chart-source-file', source),
  onChartSourceFile: (cb) => ipcRenderer.on('chart-source-file', (_, source) => cb(source)),
  setChartSourceMode: (mode) => ipcRenderer.send('chart-source-mode', mode),
  onChartSourceMode: (cb) => ipcRenderer.on('chart-source-mode', (_, mode) => cb(mode)),
